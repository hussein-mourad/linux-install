...
rsync -a --info=progress2 -h $HOME/.zshrc $HOME/.themes $HOME/.icons $HOME/.fonts $HOME/.bashrc $HOME/.vimrc j $HOME/.SpaceVim.d $HOME/.vim_back $HOME/.gitconfig $DEST/home-folder
